        ...
        <div className="mt-12 mb-12">
          ...
          <div className="grid grid-cols-5 gap-4">
            {credits?.cast.slice(0, 10).map((actor) => (
              <div
                key={actor.id}
                className="flex flex-col items-center bg-gray-800 rounded-xl p-2 shadow-sm hover:shadow-lg hover:bg-gray-700 transition"
              >
                <img
                  src={
                    actor.profile_path
                ...
                <p className="text-xs text-purple-600 text-center">{actor.character}</p>
              </div>
            ))}
          </div>
        </div>

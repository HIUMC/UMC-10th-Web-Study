...
const MovieDetailPage = () => {
  ...
  } = useCustomFetch<MovieDetail>(movieUrl, authConfig, [movieId]);

  const {
    data: credits,
    isPending: isCreditsPending,
    isError: isCreditsError,
  } = useCustomFetch<CreditsResponse>(creditsUrl, authConfig, [movieId]);
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="px-[30px] pb-[40px] pt-[24px]">
        ...
        <div className="grid grid-cols-[repeat(auto-fill,minmax(120px,1fr))] gap-x-5 gap-y-7">
          {topCast.map((actor) => (

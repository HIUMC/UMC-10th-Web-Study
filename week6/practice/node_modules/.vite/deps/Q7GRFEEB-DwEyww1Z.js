//#region node_modules/.pnpm/@tanstack+query-devtools@5.100.9/node_modules/@tanstack/query-devtools/build/chunk/Q7GRFEEB.js
var sharedConfig = {
	context: void 0,
	registry: void 0,
	effects: void 0,
...
function traverse(tree, walker2, version, origin = []) {
	...
	if (!isArray(tree)) {
		forEach(tree, (subtree, key) => traverse(subtree, walker2, version, [...origin, ...parsePath(key, legacyPaths)]));
		return;
	}
	const [nodeValue, children2] = tree;
	if (children2) forEach(children2, (child, key) => {
		traverse(child, walker2, version, [...origin, ...parsePath(key, legacyPaths)]);
	});
...
var walker = (object, identities, superJson, dedupe, path = [], objectsInThisPath = [], seenObjects = /* @__PURE__ */ new Map()) => {
	...
	forEach(transformed, (value, index) => {
		...
		if (isArray(recursiveResult.annotations)) innerAnnotations[escapeKey(index)] = recursiveResult.annotations;
...
//#endregion
export { use as $, getQueryStatusColorByLabel as A, onMount as B, delegateEvents as C, getOwner as D, getMutationStatusColor as E, memo as F, setupStyleSheet as G, serialize as H, mergeProps as I, spread as J, sortFns as K, mutationSortFns as L, getSidedProp as M, insert as N, getPreferredColorScheme as O, lazy as P, updateNestedDataByPath as Q, on as R, createUniqueId as S, displayValue as T, setAttribute as U, render as V, setStyleProperty as W, template as X, stringify as Y, untrack as Z, createEffect as _, Match as a, createRoot as b, Switch as c, className as d, useContext as et, clearDelegatedEvents as f, createContext as g, createComputed as h, Index as i, getQueryStatusLabel as j, getQueryStatusColor as k, addEventListener as l, createComponent as m, Dynamic as n, Portal as o, convertRemToPixels as p, splitProps as q, For as r, Show as s, $TRACK as t, useTransition as tt, batch as u, createMemo as v, deleteNestedDataByPath as w, createSignal as x, createRenderEffect as y, onCleanup as z };

//# sourceMappingURL=Q7GRFEEB-DwEyww1Z.js.map
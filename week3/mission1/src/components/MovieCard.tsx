...
export default function MovieCard({ movie }: MovieCardProps) {
  ...
  return (
    ...
    >
      ...
      {isHovered && (
        <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent backdrop-blur-md flex flex-col justify-center items-center text-center p-4">

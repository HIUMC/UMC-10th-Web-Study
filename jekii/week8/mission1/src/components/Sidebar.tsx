...
const Sidebar = ({ isOpen, onClose }: SidebarProps) => {
  ...
  return (
    <>
      ...
      {accessToken && (
        <aside
          className={`absolute top-0 left-0 h-full w-64 bg-white/50 dark:bg-[#1e1e24] border-r border-slate-200 dark:border-gray-800 z-40 p-5 transition-transform duration-300 ease-in-out md:static md:translate-x-0 md:shrink-0 ${

    ...
    <div className="flex flex-col items-center justify-center h-full">
      ...
      >
        ...
        <div className="flex items-center mb-2">
          ...
          <span className="text-black text-lg font-semibold absolute left-1/2 -translate-x-1/2">
            회원가입
          </span>
        </div>
        ...
        {step === "email" && (
          <>
            <button
              type="button"
              className="w-full flex items-center justify-center gap-3 border border-gray-600 bg-transparent text-black p-3 rounded-md cursor-pointer hover:bg-gray-400 transition-colors"
            >
              <img
